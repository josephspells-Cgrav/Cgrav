...
>
> **v6.0 incorporates Bunns HVAC build learnings** — particularly the visual-first
...
> verification contract now includes a visual layer it never had before.
...
|---|---|---|---|
| Next.js + React | ✅ Full support | ✅ Full support | Full doctrine (springs, blur enters, recipes 1-29) |
